...
let displayQuestionData = () => {
    ...
    TQ.textContent = quizData.length
    const scoreEle = document.getElementById('Score-ele')
    scoreEle.textContent = score
    const outofQue = document.getElementById('outofQue')
    outofQue.textContent = currentQuestion
